...
public class Utils {
	...
	public static void setWidgetDisplay( Context context, int id ) {
		...
		if ( appWidgetManager != null ) {
			...
			if ( pref_setting_textcolor != 0 ) {
				...
				Log.d( TAG, "setWidgetDisplay() pref_setting_textcolor=" + pref_setting_textcolor );
            }
	...
	private static int searchPrimeNumber() {
		...
		for ( int i = 0; i < Integer.MAX_VALUE; i++ ) {
			...
			random_number = ( int ) java.lang.Math.floor( java.lang.Math.random() * ( pref_setting_range_to - pref_setting_range_from + 1 ) + pref_setting_range_from );
	...
	protected static void loadSetting( Context context ) {
		...
		pref_setting_interval_minutes = pref.getInt( ( String ) context.getResources().getText( R.string.pref_key_interval_minutes ), 30 );
		pref_setting_textcolor = pref.getInt( ( String ) context.getResources().getText( R.string.pref_key_textcolor ), 0 );
		pref_setting_range_from = pref.getInt( ( String ) context.getResources().getText( R.string.pref_key_range_from ), 2 );
		pref_setting_range_to = pref.getInt( ( String ) context.getResources().getText( R.string.pref_key_range_to ), 1000 );
		pref_setting_showtext = pref.getString( ( String ) context.getResources().getText( R.string.pref_key_showtext ), "素数" );
		pref_setting_favorite = pref.getInt( ( String ) context.getResources().getText( R.string.pref_key_favorite ), 0 );
		pref_setting_favorite_check = pref.getBoolean( ( String ) context.getResources().getText( R.string.pref_key_favorite_check ), false );

		// Log.d( TAG, "pref_setting_interval_minutes=" + pref_setting_interval_minutes );
		Log.d( TAG, "pref_setting_textcolor=" + pref_setting_textcolor );
		// Log.d( TAG, "pref_setting_range_from=" + pref_setting_range_from );
		// Log.d( TAG, "pref_setting_range_to=" + pref_setting_range_to );
		// Log.d( TAG, "pref_setting_showtext=" + pref_setting_showtext );
		// Log.d( TAG, "pref_setting_favorite=" + pref_setting_favorite );
		// Log.d( TAG, "pref_setting_favorite_check=" + pref_setting_favorite_check );
	}
	...
	protected static void saveSetting( Context context ) {
		...
		edt.putInt( ( String ) context.getResources().getText( R.string.pref_key_interval_minutes ), pref_setting_interval_minutes );
		edt.putInt( ( String ) context.getResources().getText( R.string.pref_key_textcolor ), pref_setting_textcolor );
		edt.putInt( ( String ) context.getResources().getText( R.string.pref_key_range_from ), pref_setting_range_from );
		edt.putInt( ( String ) context.getResources().getText( R.string.pref_key_range_to ), pref_setting_range_to );
		edt.putString( ( String ) context.getResources().getText( R.string.pref_key_showtext ), pref_setting_showtext );
		edt.putInt( ( String ) context.getResources().getText( R.string.pref_key_favorite ), pref_setting_favorite );
